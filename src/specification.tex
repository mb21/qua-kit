...
% *** PERSONAL & PAPER INFO ***
\newcommand{\sAuthors}{Michael Franzen, Artem Chirkin, Lukas Treyer}
...
\input{src/main/ch0_introduction.tex}
\input{src/main/ch1_serviceapi.tex}
%\input{src/main/ch2_networking.tex}
\input{src/main/ch3_storage.tex}
\input{src/main/ch4_computing.tex}

\appendix

\input{src/appendix/builtinservices.tex}
