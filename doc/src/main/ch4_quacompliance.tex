...
\begin{lstlisting}[caption={A qua-compliant service output for mode \texttt{scenario} (string output)}, label={lst:quacompliantresult1:scenario}]
{
  callID : 213,
  result : {
...
\begin{lstlisting}[caption={A qua-compliant service output for mode \texttt{scenario} (image output)}, label={lst:quacompliantresult2:scenario}]
{
  callID : 213,
  result : {
    image : {
