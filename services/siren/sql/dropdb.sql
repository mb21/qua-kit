...
BEGIN
  ...
  EXCEPTION
    WHEN undefined_column THEN RAISE NOTICE 'Constraint "latest_geom_prop" does not exist, skipping.';
  ...
  EXCEPTION
    WHEN undefined_column THEN RAISE NOTICE 'Constraint "latest_geometry" does not exist, skipping.';
  ...
  EXCEPTION
    WHEN undefined_column THEN RAISE NOTICE 'Constraint "latest_sc_prop" does not exist, skipping.';
  ...
  EXCEPTION
    WHEN undefined_column THEN RAISE NOTICE 'Constraint "prev_geom_prop_version" does not exist, skipping.';
  ...
  EXCEPTION
    WHEN undefined_column THEN RAISE NOTICE 'Constraint "prev_geometry_version" does not exist, skipping.';
  ...
  EXCEPTION
    WHEN undefined_column THEN RAISE NOTICE 'Constraint "prev_sc_prop_version" does not exist, skipping.';
  ...
  EXCEPTION
    WHEN undefined_column THEN RAISE NOTICE 'Constraint "sc_geometry_properties" does not exist, skipping.';
    WHEN undefined_table THEN RAISE NOTICE 'Table "sc_geometry_prop" does not exist, skipping.';
  END;
  BEGIN
    ALTER TABLE sc_geometry DROP CONSTRAINT scenario_content;
  EXCEPTION
    WHEN undefined_column THEN RAISE NOTICE 'Constraint "scenario_content" does not exist, skipping.';
    WHEN undefined_table THEN RAISE NOTICE 'Table "sc_geometry" does not exist, skipping.';
  END;
  BEGIN
