...
BEGIN
  ...
  CREATE TABLE IF NOT EXISTS scenario (id bigserial, alive bool DEFAULT 'TRUE' NOT NULL, name text NOT NULL, PRIMARY KEY (id));
  ...
  CREATE TABLE IF NOT EXISTS scenario_prop_history (scenario_id bigint NOT NULL, name text NOT NULL, ts_update timestamp DEFAULT CURRENT_TIMESTAMP NOT NULL, ts_prev_update timestamp DEFAULT NULL, alive bool DEFAULT 'TRUE' NOT NULL, value text NOT NULL, PRIMARY KEY (scenario_id, name, ts_update));
