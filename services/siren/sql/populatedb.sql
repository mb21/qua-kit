...
BEGIN
  ...
  CREATE TABLE IF NOT EXISTS scenario (id bigserial, alive bool DEFAULT 'TRUE' NOT NULL, name text NOT NULL, lon decimal DEFAULT NULL, lat decimal DEFAULT NULL, alt decimal NOT NULL DEFAULT 0, srid integer NOT NULL, user text, PRIMARY KEY (id));
