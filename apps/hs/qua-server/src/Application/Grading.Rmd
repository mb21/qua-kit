...
qplot(value, data=vote_rating, geom="histogram")
...
rating_v <- sapply(vote$voter_id, function(i) vote_rating[which(vote_rating$student_id == i), "value"][1])
...
# neasure of quality: covariance of ratings i and j and choice
c(cov(rating_i, delta), cov(rating_j, delta))
