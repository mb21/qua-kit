...
uiButtons = do
  ...
  let popupSubmit = do
        ...
        toWidgetBody
              [hamlet|
                <div .popupdiv ##{popupSubmitId} style="display: none;">
                  Submit your design
        ...
        toWidgetHead
          [julius|
            ...
            function registerSubmit(onClick) {
              document.getElementById('#{rawJS submitbutton}').parentElement.style.display = "block"
            ...
            function registerServiceRun(onClick) {
              document.getElementById('#{rawJS serviceRun}').parentElement.style.display = "block"
        ...
        toWidgetBody
          [hamlet|
           <div .#{idleplaceholder} ##{guiplaceholder}>
            ...
            $#  submit button
            <svg .#{uiButton} height="64" style="left:0px; display: none;" version="1.1" viewBox="0 0 24 24" width="64" xmlns="http://www.w3.org/2000/svg">
